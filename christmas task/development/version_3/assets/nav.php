...
echo "<li> <a href='info_page_1.php'>EV Chargers</a></li>"; //link to EV chargers page
echo "<li> <a href='info_page_2.php'>Smart Meters</a></li>"; //link to smart meter page
echo "<li> <a href='info_page_3.php'>Solar Panels</a></li>"; //link to solar panels page

if(isset($_SESSION['[staff session name]']) AND $_SESSION['active'] == 1) { //checks if the session has an active engineer in it, active meaning they have been through the 2fa process
