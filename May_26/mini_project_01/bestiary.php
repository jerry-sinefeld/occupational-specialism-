...
echo "<div class='container'>"; //creates a div and gives it a class so I can apply this specific layout to chosen divs
    echo "<ol class='coll_ol"; //creates an ordered list with a name to be referenced in the css
        ...
        echo "<img width='350' height='350' src='Images/jackbaker.jpg' alt='Jack Baker'>"; //displays an image with a source as well as measurements and alternate text that appears if image doesn't load
        ...
        echo "<img width='225' height='225' src='Images/Margureite.jpg' alt='Marguriete Baker'>"; //displays an image with a source as well as measurements and alternate text that appears if image doesn't load
        ...
        echo "<img width='189' height='267' src='Images/Lucas.jpg' alt='Lucas Baker'>"; //displays an image with a source as well as measurements and alternate text that appears if image doesn't load
        ...
        echo "<img width='450' height='360' src='Images/molded.png' alt='molded'>"; //displays an image with a source as well as measurements and alternate text that appears if image doesn't load
        ...
        echo "<img width='228' height='221' src='Images/blade_molded.jpg' alt='Blade molded'>"; //displays an image with a source as well as measurements and alternate text that appears if image doesn't load
        echo "<p>Difficulty:1/5</p>";//content
        ...
        echo "<img width='450' height='360' src='Images/molded-crawler.png' alt='Molded crawler'>"; //displays an image with a source as well as measurements and alternate text that appears if image doesn't load
        ...
        echo "<img width='450' height='360' src='Images/molded-fat.png' alt='Fat molded'>"; //displays an image with a source as well as measurements and alternate text that appears if image doesn't load
        ...
        echo "<img width='450' height='360' src='Images/bomb.png' alt='Tripwire bomb'>"; //displays an image with a source as well as measurements and alternate text that appears if image doesn't load
        echo "<p>Difficulty:0/5</p>";//content
        ...
        echo "<img width='450' height='360' src='Images/wooden-crate.png' alt='Trapped wood crate'>"; //displays an image with a source as well as measurements and alternate text that appears if image doesn't load
        echo "<p>Difficulty:0/5</p>";//content
