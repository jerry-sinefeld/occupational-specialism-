...
echo "</head>"; //closes head
    ...
    echo "<div class='res_title'>";
        echo "<p1>RESIDENT E<span class='seven_color'>VIL</span> ENCYCLOPEDIA</p1>"; //opening paragraph that I use as a semi title, this contains the span tag which allows you to color chosen words and/or letters
    echo "</div>";
    ...
    echo "<ol class='coll_ol"; //creates an ordered list with a name to be referenced in the css
        ...
        echo "<img class='enc_size' src='images/separating-agent.png' alt='separating agent'>"; //displays an image with a source as well as measurements and alternate text that appears if image doesn't load
        ...
        echo "<img class='enc_size' src='images/strong-chem-fluid.png' alt='strong chem fluid'>"; //displays an image with a source as well as measurements and alternate text that appears if image doesn't load
        ...
        echo "<img class='enc_size' src='images/chem-fluid.png' alt='Chem fluid'>"; //displays an image with a source as well as measurements and alternate text that appears if image doesn't load
        ...
        echo "<img class='enc_size' src='images/herb.png' alt='Herb'>"; //displays an image with a source as well as measurements and alternate text that appears if image doesn't load//
        echo "<p>Rarity:1/5</p>";//content
        ...
        echo "<img class='enc_size' src='images/supplements.png' alt='supplements'>"; //displays an image with a source as well as measurements and alternate text that appears if image doesn't load
        echo "<p>Rarity:4/5</p>";//content
        ...
        echo "<img class='enc_size' src='images/psychostimulants.png' alt='psychostimulants'>"; //displays an image with a source as well as measurements and alternate text that appears if image doesn't load
        echo "<p>Rarity:4/5</p>";//content
        ...
        echo "<img class='enc_size' src='images/first-aid-med.png' alt='first aid med'>"; //displays an image with a source as well as measurements and alternate text that appears if image doesn't load
        ...
        echo "<img class='enc_size' src='images/strong-first-aid-med.png' alt='strong first aid med'>"; //displays an image with a source as well as measurements and alternate text that appears if image doesn't load
        echo "<p>Rarity:4/5</p>";//content
        ...
        echo "<img class='enc_size' src='images/stabilizer.png' alt='stabilizer'>"; //displays an image with a source as well as measurements and alternate text that appears if image doesn't load
        ...
        echo "<img class='enc_size' src='images/steroids.png' alt='steroids'>"; //displays an image with a source as well as measurements and alternate text that appears if image doesn't load
        echo "<p>Rarity:Special</p>";//content
        ...
        echo "<img class='enc_size' src='images/solid-fuel.png' alt='solid fuel'>"; //displays an image with a source as well as measurements and alternate text that appears if image doesn't load
        echo "<p>Rarity:2/5</p>";//content
        ...
        echo "<img class='enc_size' src='images/gunpowder.jpg' alt='gunpowder'>"; //displays an image with a source as well as measurements and alternate text that appears if image doesn't load
        echo "<p>Rarity:2/5</p>";//content
        ...
        echo "<img class='enc_size' src='images/ammo.jpg' alt='Ammo'>"; //displays an image with a source as well as measurements and alternate text that appears if image doesn't load
