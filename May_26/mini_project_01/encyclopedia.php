...
echo "<div class='container'>"; //creates a div and gives it a class so I can apply this specific layout to chosen divs
    echo "<ol class='coll_ol"; //creates an ordered list with a name to be referenced in the css
        ...
        echo "<img width='600' height='380' src='Images/separating-agent.png' alt='separating agent'>"; //displays an image with a source as well as measurements and alternate text that appears if image doesn't load
        ...
        echo "<img width='600' height='380' src='Images/strong-chem-fluid.png' alt='strong chem fluid'>"; //displays an image with a source as well as measurements and alternate text that appears if image doesn't load
        ...
        echo "<img width='600' height='380' src='Images/chem-fluid.png' alt='Chem fluid'>"; //displays an image with a source as well as measurements and alternate text that appears if image doesn't load
        ...
        echo "<img width='600' height='380' src='Images/herb.png' alt='Herb'>"; //displays an image with a source as well as measurements and alternate text that appears if image doesn't load
        echo "<p>Rarity:1/5</p>";//content
        ...
        echo "<img width='600' height='380' src='Images/supplements.png' alt='supplements'>"; //displays an image with a source as well as measurements and alternate text that appears if image doesn't load
        echo "<p>Rarity:4/5</p>";//content
        ...
        echo "<img width='600' height='380' src='Images/psychostimulants.png' alt='psychostimulants'>"; //displays an image with a source as well as measurements and alternate text that appears if image doesn't load
        echo "<p>Rarity:4/5</p>";//content
        ...
        echo "<img width='600' height='380' src='Images/first-aid-med.png' alt='first aid med'>"; //displays an image with a source as well as measurements and alternate text that appears if image doesn't load
        ...
        echo "<img width='600' height='380' src='Images/strong-first-aid-med.png' alt='strong first aid med'>"; //displays an image with a source as well as measurements and alternate text that appears if image doesn't load
        echo "<p>Rarity:4/5</p>";//content
        ...
        echo "<img width='600' height='380' src='Images/stabilizer.png' alt='stabilizer'>"; //displays an image with a source as well as measurements and alternate text that appears if image doesn't load
        ...
        echo "<img width='600' height='380' src='Images/steroids.png' alt='steroids'>"; //displays an image with a source as well as measurements and alternate text that appears if image doesn't load
        echo "<p>Rarity:Special</p>";//content
        ...
        echo "<img width='600' height='380' src='Images/solid-fuel.png' alt='solid fuel'>"; //displays an image with a source as well as measurements and alternate text that appears if image doesn't load
        echo "<p>Rarity:2/5</p>";//content
        ...
        echo "<img width='600' height='380' src='Images/gunpowder.jpg' alt='gunpowder'>"; //displays an image with a source as well as measurements and alternate text that appears if image doesn't load
        echo "<p>Rarity:2/5</p>";//content
        ...
        echo "<img width='600' height='380' src='Images/ammo.jpg' alt='Ammo'>"; //displays an image with a source as well as measurements and alternate text that appears if image doesn't load
