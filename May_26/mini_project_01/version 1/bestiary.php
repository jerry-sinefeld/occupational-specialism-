...
echo "<div class='container'>"; //creates a div and gives it a class so I can apply this specific layout to chosen divs
    echo "<ol class='coll_ol"; //creates an ordered list with a name to be referenced in the css
        ...
        echo "<img id='jack' src='images/jackbaker.jpg' alt='Jack Baker'>"; //displays an images with a source as well as measurements and alternate text that appears if images doesn't load
        ...
        echo "<img id='marge' src='images/Margureite.jpg' alt='Marguriete Baker'>"; //displays an images with a source as well as measurements and alternate text that appears if images doesn't load
        ...
        echo "<img id='Lucas' src='images/Lucas.jpg' alt='Lucas Baker'>"; //displays an images with a source as well as measurements and alternate text that appears if images doesn't load
        ...
        echo "<img id='Molded' src='images/molded.png' alt='molded'>"; //displays an images with a source as well as measurements and alternate text that appears if images doesn't load
        ...
        echo "<img id='Blade_molded' src='images/blade_molded.jpg' alt='Blade molded'>"; //displays an images with a source as well as measurements and alternate text that appears if images doesn't load
        echo "<p>Difficulty:1/5</p>";//content
        ...
        echo "<img id='crawler_molded' src='images/molded-crawler.png' alt='Molded crawler'>"; //displays an images with a source as well as measurements and alternate text that appears if images doesn't load
        ...
        echo "<img id='Fat_molded' src='images/molded-fat.png' alt='Fat molded'>"; //displays an images with a source as well as measurements and alternate text that appears if images doesn't load
        ...
        echo "<img id='tripwire' src='images/bomb.png' alt='Tripwire bomb'>"; //displays an images with a source as well as measurements and alternate text that appears if images doesn't load
        echo "<p>Difficulty:0/5</p>";//content
        ...
        echo "<img id='Box_trap' src='images/wooden-crate.png' alt='Trapped wood crate'>"; //displays an images with a source as well as measurements and alternate text that appears if images doesn't load
        echo "<p>Difficulty:0/5</p>";//content
