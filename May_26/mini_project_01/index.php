...
echo "<html>"; //opens html
    ...
    echo "<body>"; //opens body
        echo "<p>RESIDENT E<span class='seven_color'>VIL</span> COMPLETIONIST GUIDE</p>"; //opening paragraph that I use as a semi title, this contains the span tag which allows you to color chosen words and/or letters
