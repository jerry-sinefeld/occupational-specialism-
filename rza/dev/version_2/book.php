...
$tickets = ticket_getter(dbconnect_insert());
...
echo "<label for = 'staff'> Employee </label>";
...
foreach ($staff as $staf) {//dropdown menu
    ...
    echo "<option value ='" . $staf ['employ_id'] . "'>" . " " . $staf['fname'] . " " .
...
foreach ($tickets as $ticket) {//dropdown menu
    echo "<option value ='" . $ticket ['ticket_id'] . "'>" . " " . $ticket['type'] . " " .
        $ticket['price']."£". " " . $ticket['quantity']. "</option>";
}
