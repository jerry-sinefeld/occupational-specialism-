...
if (isset($_SESSION['employ_id'])) {//checks if user is already logged in if so it directs you to the index page
    ...
    if ($staff ) {
        $_SESSION['employ_id'] = true;
        $_SESSION['employ_id'] = $staff['employ_id'];
