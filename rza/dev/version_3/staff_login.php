...
if (isset($_SESSION[''])) {//checks if user is already logged in if so it directs you to the index page
    ...
    if ($staff ) {
        ...
        auditor(dbconnect_insert(), $_SESSION['[staff session name]'], "log", "Engineer has logged in");
