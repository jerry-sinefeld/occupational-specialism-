...
if (!isset($_SESSION['employid'])) {// TODO: POTENTIAL CHANGE NEEDED
    ...
    if (isset($_POST['bookdelete'])) {
        try {
            if (cancel_book(dbconnect_insert(), $_POST['book_id'])) {// TODO: POTENTIAL CHANGE NEEDED
                ...
                auditor(dbconnect_insert(), $_SESSION['employid'], "log", "Staff has cancelled appointment");// TODO: POTENTIAL CHANGE NEEDED
            } else {
